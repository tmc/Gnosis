...
# # ============================
# # Better Feature Extractors (Pro) — dtype-safe, no SVD
# # ============================
# import math, torch
# import torch.nn as nn
# import torch.nn.functional as F
...
#     Streams:
#       • Gated Dilated Depthwise Conv stack over time (local patterns at multiple scales)
#       • Light SAB over time (global mixing)
#       • FFT + trend/volatility stats on channel-mean
#       • PMA pooling with K seeds → flatten → MLP
#     """
#     def __init__(
#         self,
#         D_model: int,
...
#         Returns 10 dims: [μ, σ², TV, p90|Δ|, early-late, last, P_low, P_mid, P_high, P_vhigh]
#         """
#         B, k = seq_mean.shape
...
#     Design:
#       1) Multi-branch temporal encoding (raw, derivative, logit) → mask-aware downsample to k
...
#         # stats head: (μ, σ², TV, p90|Δ|, slope, R2, max_drawdown, #peaks,
...
#                 mixer_layers=3, mixer_heads=4, mixer_enable_T_max=2048
#             )
#         else:
